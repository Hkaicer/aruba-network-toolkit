...
commands_input = st.text_area(
    "Enter the CLI commands separated by commas (e.g., show hostname, show system):",
    value="show hostname, show system, show interface transceiver, show interface brief"
)
